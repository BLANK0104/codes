...
___________________________________________________________________________________________\033[0m"""
        for karakter in obj:
            print(karakter,end="",flush=True)
        listx = ["     ██ 39%","     ███ 49%","     ████ 76%","     █████ 89%","     ██████ 100%","     ██████  GENERATE DATA","     ██████         GENERATE OBJECT","     ██████                      GENERATE FUNCTION","     ██████                         COLLECTIONG DATA","     ██████                      DOING WORK","     ██████               CONNECTING TO SERVER............","     ██████          CONNECTING TO SERVER .............","     ██████  S T A R T I N G     S I M U L A T I O N"]
        count = 0
        for c in listx:
            if count != len(listx):
                sys.stdout.write('\r' + c)
